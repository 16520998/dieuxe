...
namespace dieuxe.Helpers
{
    public static class MapFunction
    {
        ...
        public static async Task<MapDirectionResponse> GetDirectionJsonAsync(Coordinate origin, Coordinate destination, List<Coordinate> waypoints)
        {
        ...
        public static async Task<string> GetPolyline(Coordinate origin, Coordinate destination, List<Coordinate> waypoints)
        {
            //var property_list = get_ORG_DES_WAY(listPoint);
